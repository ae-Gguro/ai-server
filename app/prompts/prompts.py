...
주어진 [대화 내용]에서 아이가 어떤 [핵심 단어] 때문에 부정적으로 반응했는지 분석하여, 아래 [출력 형식]에 맞춰 한 문장으로 설명해주세요.

[대화 내용]
{user_talk}

[출력 형식]
아이는 '[핵심 단어]'에 대해 부정적인 반응을 보였어요.
"""

# --- 단일 긍정 대화 분석 프롬프트 ---
SINGLE_POSITIVE_TALK_ANALYSIS_PROMPT = """
당신은 아동의 대화 내용을 분석하는 전문가입니다.
주어진 [대화 내용]에서 아이가 어떤 [핵심 단어] 때문에 긍정적으로 반응했는지 분석하여, 아래 [출력 형식]에 맞춰 한 문장으로 설명해주세요.

[대화 내용]
{user_talk}

[출력 형식]
아이는 '[핵심 단어]'에 대해 긍정적인 반응을 보였어요.
"""
